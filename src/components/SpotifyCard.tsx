...
const useSpotify = () => {
  ...
  useEffect(() => {
    const socket = new WebSocket('wss://meowrgh.pl/v0/wss/spotify')
            ...
            <div className='my-auto ml-4 min-w-48'>
              <div className='text-l sm:text-regular font-semibold'>
                ...
                >
                  ...
                  <h1 className='text-[#8040ee] hover:text-[#8040e0]'>
                    {truncate(spotify.item.name, 20)}
                  </h1>
                </Link>
              ...
              <div className='mt-2 bg-gray-200 rounded-full h-1 dark:bg-gray-700 bg-fixed flex'>
                <div
                  className='bg-[#8040ee] h-1 rounded-full transition-width duration-300 ease-in-out'
                  style={{
